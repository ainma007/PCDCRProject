...
-- --------------------------------------------------
-- Date Created: 08/03/2016 13:31:38
...
IF OBJECT_ID(N'[dbo].[FK_ProjectControl_Programs_Table]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProjectControl] DROP CONSTRAINT [FK_ProjectControl_Programs_Table];
GO
...
IF OBJECT_ID(N'[dbo].[FK_ProjectControl_Projects_table]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProjectControl] DROP CONSTRAINT [FK_ProjectControl_Projects_table];
GO
IF OBJECT_ID(N'[dbo].[FK_ProjectControl_Users_Table]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProjectControl] DROP CONSTRAINT [FK_ProjectControl_Users_Table];
GO
...
-- Creating primary key on [ID] in table 'ProjectControl'
ALTER TABLE [dbo].[ProjectControl]
ADD CONSTRAINT [PK_ProjectControl]
    PRIMARY KEY CLUSTERED ([ID] ASC);
GO
...
-- Creating foreign key on [UserID] in table 'ProjectControl'
ALTER TABLE [dbo].[ProjectControl]
...
-- Creating foreign key on [ProjectID] in table 'ProjectControl'
ALTER TABLE [dbo].[ProjectControl]
