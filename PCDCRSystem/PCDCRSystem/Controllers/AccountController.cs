...
namespace PCDCRSystem.Controllers
{
    public class AccountController : Controller
    {
        ...
        public void SetUserOffLine()
        {
            ...
            string totaltime = this.ComputeTime(entity.LogInTime.Value);
        ...
        #endregion
        //( Abu Ehab ) : Compute Total Time Of User OnLine
        private string ComputeTime(DateTime Dob)
        {
            ...
            return String.Format("Age: {0} Year(s)  / {1}  Month(s)   / {2} Day(s)   / {3} Minutes(s)  , / {4} Seconds(s) ",
